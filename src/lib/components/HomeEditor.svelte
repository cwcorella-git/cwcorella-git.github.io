...
<style>
	...
	.toolbar button:hover { color: var(--clr-text); border-color: rgba(var(--ui-rgb), 0.28); }
	...
	textarea:focus { border-color: rgba(var(--ui-rgb), 0.32); }
	...
	button.cancel:hover:not(:disabled) { color: var(--clr-text); border-color: rgba(var(--ui-rgb), 0.32); }
	button.save {
		background: rgba(var(--ui-rgb), 0.06);
		border-color: rgba(var(--ui-rgb), 0.25);
		color: var(--clr-text);
	}
	button.save:hover:not(:disabled) { background: rgba(var(--ui-rgb), 0.12); }
