...
author: Vikky Storm and Eme Flores
date: 4/24/2019
pubdate: '2019-04-27T13:59:02'
language: en
topics:
- gender
- gender abolition
...
converted_date: '2025-11-08T11:25:17.506805'
---
...
This new system has a few characteristics which define it. Not all of them developed at once, but they’ve been imposed upon the whole world. They are as follows:
 ...
 1. Marriage is an economic contract between a man and a woman. Men and women are supposed to sign an agreement to be faithful and to stay together and violation of that is seen as a breach of contract and therefore bad.

 1. Marriage is a personal choice done for love rather than a social choice done for necessity. Gone are marriages for alliances or arranged marriages, for the most part. Marriage is only a choice for the two who are getting married.

 1. In marriage, the man is expected to make money to support the woman and the woman is expected to clean up the home, take care of the children, cook, and shop.
...
As such, we cannot engage in gender abolition without abolishing all forms of class. To do away with gender, so too must go capitalism, race, neuronormativity, and the state. These things are one system. They form a single liberal social order which cannot be allowed to continue. Our object is not just an end to one part, but an end to class society itself.
